package DSFLib
  package Circuits
    ...
    package Examples
      ...
      package SolarPanels
        ...
        model ModulatedSolarPanel
          parameter Integer N = 3, M = 4;
          DSFLib.Circuits.Examples.SolarPanels.ModulatedSolarCell[N, M] cell;
          DSFLib.Circuits.Interfaces.Pin p annotation(
            Placement(visible = true, transformation(origin = {100, 58}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {104, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
          DSFLib.Circuits.Interfaces.Pin n annotation(
            Placement(visible = true, transformation(origin = {98, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-104, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
          DSFLib.ControlSystems.Blocks.Interfaces.RealInput u annotation(
            Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 54}, extent = {{-8, -8}, {8, 8}}, rotation = -90)));
        equation
          for i in 1:N loop
            for j in 1:M - 1 loop
              connect(cell[i, j].p, cell[i, j + 1].p);
          ...
          for i in 1:N loop
            for j in 1:M loop
              connect(u, cell[i, j].u);
            end for;
          end for;
          connect(u, cell[1, 1].u);
          annotation(
            Icon(graphics = {Bitmap(origin = {-1, -3}, rotation = 90, extent = {{-99, 95}, {99, -95}}, imageSource = ""), Line(origin = {190.086, 0.362069}, points = {{-70, 30}, {-70, 10}}, color = {0, 0, 255}), Line(origin = {190.086, 0.362069}, points = {{-80, 20}, {-60, 20}}, color = {0, 0, 255})}));
        end ModulatedSolarPanel;
        ...
        package Examples
          model TwoCells
            ...
            DSFLib.Circuits.Examples.SolarPanels.SolarCell solarCell_1 annotation(
              Placement(visible = true, transformation(origin = {-30, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
            DSFLib.Circuits.Examples.SolarPanels.SolarCell solarCell_2 annotation(
          ...
          model SolarPanel
            ...
            DSFLib.Circuits.Examples.SolarPanels.SolarPanel solarPanel(M = 10, N = 5) annotation(
  ...
  package Mechanical
    package Translational
      ...
      package Components
        ...
        equation
          ...
          annotation(
            Diagram,
            Icon(graphics = {Text(origin = {-2, -61}, extent = {{-104, 13}, {104, -13}}, textString = "F=%F"), Text(origin = {-2, -6}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Polygon(origin = {40, 0}, lineColor = {0, 127, 0}, fillColor = {160, 215, 160}, fillPattern = FillPattern.Solid, points = {{-100, 10}, {14, 10}, {14, 27}, {60, 0}, {14, -27}, {14, -10}, {-100, -10}, {-100, 10}}), Line(origin = {-77, 0}, points = {{17, 0}, {-17, 0}, {-17, 0}})}));
        end ConstForce;
    ...
    package Rotational
      ...
      package Components
        ...
        equation
          ...
          annotation(
            Icon(graphics = {Text(textColor = {0, 0, 255}, extent = {{-150, 80}, {150, 40}}, textString = "%name"), Line(points = {{-100, 0}, {-58, 0}, {-43, -30}, {-13, 30}, {17, -30}, {47, 30}, {62, 0}, {100, 0}}), Text(extent = {{-150, -40}, {150, -80}}, textString = "k=%k")}));
        end Spring;
    ...
    package RotoTranslational
      package Components
        ...
        model RetractableCord
        extends DSFLib.Mechanical.Translational.Interfaces.Compliant;
        parameter Real L0(unit = "m") = 1, r(unit = "m") = 0.1;
      DSFLib.Mechanical.Rotational.Interfaces.Flange flange_r annotation(
          Placement(visible = true, transformation(origin = {0, 0}, extent = {{0, 0}, {0, 0}}, rotation = 0), iconTransformation(origin = {-20, 2}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
      equation
        s_rel = L0 - r*flange_r.phi;
        flange_r.tau = f*r;
        annotation(
          Icon(graphics = {Line(origin = {-67.262, -4.01312}, points = {{-37, 4}, {57, 4}, {57, 4}}), Line(origin = {47.7844, -19.2006}, points = {{-41.7844, -18.7994}, {8.21555, 19.2006}, {42.2156, 19.2006}, {54.2156, 19.2006}}), Ellipse(origin = {-20, 2}, lineColor = {30, 30, 30}, fillColor = {231, 231, 231}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-48, 48}, {48, -48}}), Text(origin = {49, 82}, rotation = -90, extent = {{-99, 14}, {97, -8}}, textString = "r=%r"), Ellipse(origin = {60, -12}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, extent = {{-12, 12}, {12, -12}}), Ellipse(origin = {-20, 2}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, extent = {{-40, 40}, {40, -40}}), Ellipse(origin = {-20, 2}, lineColor = {40, 40, 40}, fillColor = {234, 234, 234}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-20, 20}, {20, -20}}), Ellipse(origin = {60, -12}, fillPattern = FillPattern.Solid, extent = {{-4, 4}, {4, -4}})}));
      end RetractableCord;
      end Components;
  ...
  package Hydraulics
    ...
    package Components
      ...
      equation
        p - RH*q = 0;
        annotation(
          Icon(graphics = {Polygon(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-100, 50}, {100, -50}, {100, 50}, {0, 0}, {-100, -50}, {-100, 50}}), Text(origin = {0, 14}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Text(origin = {0, -18}, extent = {{-150, -40}, {150, -80}}, textString = "RH=%RH")}, coordinateSystem(initialScale = 0.1)));
      end Valve;
      ...
      equation
        ...
        annotation(
          Diagram,
          Icon(coordinateSystem(initialScale = 0.1), graphics = {Text(origin = {29, 70}, extent = {{-103, 10}, {49, -10}}, textString = "A=%A"), Text(extent = {{-95, -24}, {95, -44}}, textString = DynamicSelect("%level_start", String(level, 2, 1, true))), Rectangle(fillColor = {85, 170, 255}, fillPattern = FillPattern.VerticalCylinder, extent = DynamicSelect({{-100, -100}, {100, 10}}, {{-100, -100}, {100, (-100 + ((200*level)/height))}})), Line(points = {{-100, 100}, {-100, -100}, {100, -100}, {100, 100}}), Text(textColor = {0, 0, 255}, extent = {{-150, 110}, {150, 150}}, textString = "%name")}));
      end Tank;
      ...
      equation
        I*der(q) = p;
        annotation(
          Icon(graphics = {Text(origin = {7, 58}, rotation = 180, extent = {{-99, 8}, {115, -14}}, textString = "I=%I"), Rectangle(rotation = -90, fillColor = {0, 170, 255}, fillPattern = FillPattern.VerticalCylinder, extent = {{-14, 96}, {14, -96}})}, coordinateSystem(initialScale = 0.1)));
      end Inertance;
      ...
      equation
        p = rho*g*H;
        annotation(
          Icon(graphics = {Rectangle(rotation = -90, fillColor = {0, 170, 255}, fillPattern = FillPattern.VerticalCylinder, extent = {{-14, 96}, {14, -96}}), Text(origin = {7, 56}, rotation = 180, extent = {{-99, 8}, {115, -14}}, textString = "H=%H")}, coordinateSystem(initialScale = 0.1)));
      end Column;
      ...
      equation
        fluidPort.p = P;
        annotation(
          Icon(graphics = {Rectangle(origin = {71, 0}, fillColor = {0, 127, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-29, 32}, {29, -32}}), Ellipse(fillColor = {0, 170, 255}, fillPattern = FillPattern.Sphere, extent = {{-80, 80}, {80, -80}}), Text(origin = {0, -200}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Text(origin = {-26, 107}, rotation = 180, extent = {{-210, 7}, {152, -9}}, textString = "P=%P")}, coordinateSystem(initialScale = 0.1)));
      end ConstPress;
    ...
    package Examples
      ...
      model TankValve
        ...
        Components.IdealPump idealPump annotation(
  ...
  package Thermal
    ...
    package Components
      ...
      equation
        ...
        T = heatPort.T;
        annotation(
          Icon(graphics = {Rectangle(origin = {0, 10}, fillColor = {255, 0, 0}, fillPattern = FillPattern.VerticalCylinder, extent = {{-80, 70}, {80, -70}}), Text(origin = {-1, 97}, extent = {{-151, 11}, {151, -11}}, textString = "C=%C"), Text(origin = {0, 58}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name")}));
      end HeatCapacitor;
    ...
    package Examples
      ...
      equation
        connect(heatCapacitor.heatPort, thermalResistor.heatPort_b) annotation(
          Line(points = {{-54, 26}, {-54, 14}, {-34, 14}}));
        connect(heatFlowSource.heatPort, heatCapacitor.heatPort) annotation(
          Line(points = {{-74, 14}, {-54, 14}, {-54, 26}}));
        connect(heatCapacitor1.heatPort, thermalResistor.heatPort_a) annotation(
    ...
    package ElectroMechanical
      package Components
        ...
        DSFLib.Circuits.Interfaces.Pin n annotation(
          ...
          Placement(visible = true, transformation(origin = {-100, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-120, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Circuits.Interfaces.Pin n_exc annotation(
          Placement(visible = true, transformation(origin = {-100, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-120, -62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  connect(n_exc, ground1.p) annotation(
          ...
          annotation(
          Icon(graphics = {Bitmap(origin = {-1, -9}, extent = {{89, -89}, {-89, 89}}, imageSource = ""), Line(origin = {-32, 76}, points = {{-28, 22}, {-28, -8}, {28, -8}, {28, -22}, {28, -22}}), Line(origin = {34, 75}, points = {{26, 21}, {26, -7}, {-26, -7}, {-26, -21}, {-26, -21}}), Line(origin = {-104, 24}, points = {{-16, 16}, {4, 16}, {4, -16}, {16, -16}, {16, -16}}), Line(origin = {-104, -48}, points = {{-16, -14}, {4, -14}, {4, 14}, {16, 14}, {16, 14}})}));
      end DCMotorSepExc;
  ...
  DSFLib.Circuits.Components.ModulatedVoltageSource Va annotation(
  ...
  ControlSystems.Blocks.Components.RampSource rampSource(U = 460, t0 = 2, tf = 5)  annotation(
        ...
        equation
  connect(Va.n, motor.n) annotation(
            Line(points = {{-10, 46}, {-10, 30}}));
  connect(rampSource.y, Va.u) annotation(
            Line(points = {{-32, 56}, {-16, 56}}));
  connect(Va.p, motor.p) annotation(
            Line(points = {{-10, 66}, {-10, 76}, {30, 76}, {30, 30}}));
    ...
    package HydroThermal
      ...
      package Examples
        model SolarCollector
          DSFLib.Thermal.Components.HeatCapacitor heatCapacitor(C = 4184) annotation(
            Placement(visible = true, transformation(origin = {8, -18}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
          DSFLib.Thermal.Components.HeatCapacitor heatCapacitor1(C = 1000) annotation(
          ...
          DSFLib.Thermal.Components.ConstTemp constTemp1(T = 293) annotation(
            Placement(visible = true, transformation(origin = {80, -4}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
          DSFLib.Hydraulics.Components.ConstPress constPress1 annotation(
        ...
        equation
          ...
          connect(convection.heatPort_a, heatCapacitor.heatPort) annotation(
            Line(points = {{-18, -4}, {8, -4}, {8, -10}}));
          connect(convection1.heatPort_b, heatCapacitor.heatPort) annotation(
            Line(points = {{32, -4}, {8, -4}, {8, -10}}));
    ...
    package ElectroThermal
      ...
      package Examples
        model WaterHeater
          ...
          DSFLib.Thermal.Components.HeatCapacitor heatCapacitor(C = 4184*10) annotation(
          ...
          DSFLib.Hydraulics.Components.ConstPress constPress annotation(
            Placement(visible = true, transformation(origin = {-88, 36}, extent = {{10, 10}, {-10, -10}}, rotation = 180)));
          DSFLib.Hydraulics.Components.ConstPress constPress1 annotation(
  ...
  package ControlSystems
    package Blocks
      ...
      package Components
        ...
        equation
          y = k1*u1 + k2*u2;
          annotation(
            Icon(graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-63, 58}, extent = {{-29, 22}, {29, -22}}, textString = "%k1"), Text(origin = {-63, -58}, extent = {{-29, 22}, {29, -22}}, textString = "%k2"), Line(origin = {19.0908, (-0 - 8)}, points = {{0, 40}, {0, -40}}, thickness = 0.5), Line(origin = {19.6908, (-0 - 8)}, points = {{-40, 0}, {40, 0}}, thickness = 0.5)}));
        end Add;
    ...
    package Examples
      model MotorControl
        DSFLib.ControlSystems.Blocks.Interfaces.RealInput u(start = 460) annotation(
          Placement(visible = true, transformation(origin = {-112, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-117, 1}, extent = {{-17, -17}, {17, 17}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Interfaces.RealOutput y annotation(
          Placement(visible = true, transformation(origin = {112, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {118, 1.77636e-15}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
        DSFLib.Circuits.Components.ConstVolt Vexc(V = 184) annotation(
        ...
        DSFLib.Circuits.Components.Inductor La(L = 0.003, i(start = 10.50285302169937)) annotation(
        ...
        DSFLib.Mechanical.Rotational.Components.Inertia inertia(J = 15, w(start = 69.46819401913424)) annotation(
      ...
      model linearized_model "DSFLib_ControlSystems_Examples_MotorControl"
        parameter Integer n = 4 "number of states";
        parameter Integer m = 1 "number of inputs";
        parameter Integer p = 1 "number of outputs";
        parameter Real x0[n] = {10.50285302169937, 69.46819401913424, 1594.531924877615, 413.385996015012};
        parameter Real u0[m] = {460};
        parameter Real A[n, n] = [-16.66660110690764, -2204.725155924119, 0, -370.4971400789569; 0.4409450758866451, -0.06666666194323966, 0, 0.01120305392440415; 0, 0.9999999291476926, 0, 0; 0, 0, 0, -0.7560006393921266];
        parameter Real B[n, m] = [333.3333332161497; 0; 0; 0];
        parameter Real C[p, n] = [0, 0.9999999291476926, 0, 0];
        parameter Real D[p, m] = [0];
        Real x[n](start = x0);
        input Real u[m](start = u0);
        output Real y[p];
        Real 'x_La.i' = x[1];
        Real 'x_inertia.w' = x[2];
        Real 'x_sepExcDCM.flange.phi' = x[3];
        Real 'x_sepExcDCM.inductor.phi' = x[4];
        Real 'u_u' = u[1];
        Real 'y_y' = y[1];
      equation
        der(x) = A*x + B*u;
      ...
      model ControlledDCMotor
        ...
        DSFLib.ControlSystems.Blocks.Components.Gain gain(K = 20) annotation(
          Placement(visible = true, transformation(origin = {-20, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.ControlSystems.Examples.MotorControl motor(u(start = 0)) annotation(
          Placement(visible = true, transformation(origin = {84, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Components.ConstSource w0(U = 69.46819401913424) annotation(
          Placement(visible = true, transformation(origin = {-118, -8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Components.StepSource delta_w(Ti = 2, U = -69.46819401913424*0.1) annotation(
          Placement(visible = true, transformation(origin = {-118, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Components.Add add2 annotation(
          Placement(visible = true, transformation(origin = {-82, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Components.ConstSource V0(U = 460) annotation(
          Placement(visible = true, transformation(origin = {-20, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Components.Add add1 annotation(
      ...
      equation
        connect(add.y, gain.u) annotation(
          Line(points = {{-38, 5.8}, {-32, 5.8}}));
        connect(add.u2, motor.y) annotation(
          Line(points = {{-61.8, 0}, {-65.4, 0}, {-65.4, -40}, {118.6, -40}, {118.6, 0}, {108.6, 0}}));
        connect(add2.y, add.u1) annotation(
          Line(points = {{-70, 11.8}, {-62, 11.8}, {-62, 12}}));
        connect(w0.y, add2.u2) annotation(
          Line(points = {{-106.4, -8}, {-100.4, -8}, {-100.4, 6}, {-94.4, 6}}));
        connect(delta_w.y, add2.u1) annotation(
          Line(points = {{-106.4, 32}, {-100.4, 32}, {-100.4, 18}, {-94.4, 18}}));
        connect(add1.y, motor.u) annotation(
          Line(points = {{52, -0.2}, {54.5, -0.2}, {54.5, -0.4}, {61, -0.4}}));
        connect(V0.y, add1.u2) annotation(
          Line(points = {{-8.4, -20}, {21.8, -20}, {21.8, -6}, {27.6, -6}}));
        connect(gain.y, integrator.u) annotation(
          Line(points = {{-8, 6}, {-2, 6}}));
        connect(integrator.y, add1.u1) annotation(
          Line(points = {{22, 6}, {28, 6}}));
      protected
      end ControlledDCMotor;

      model MotorControlTorque
        DSFLib.ControlSystems.Blocks.Interfaces.RealInput p annotation(
          Placement(visible = true, transformation(origin = {44, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {1, 117}, extent = {{-17, -17}, {17, 17}}, rotation = -90)));
        extends DSFLib.ControlSystems.Blocks.Interfaces.SISO(u(start = 460));
        DSFLib.Circuits.Components.ConstVolt Vexc(V = 184) annotation(
          Placement(visible = true, transformation(origin = {-51, -1}, extent = {{-11, -11}, {11, 11}}, rotation = -90)));
        DSFLib.Circuits.Components.Resistor Rexc(R = 25.2) annotation(
          Placement(visible = true, transformation(origin = {-27, 23}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
      ...
      equation
        ...
        connect(angSpeedSensor.y, y) annotation(
          Line(points = {{80, -48}, {88, -48}, {88, 0}, {110, 0}}));
        connect(p, tauSource.u) annotation(
          Line(points = {{44, 100}, {44, 62}}));
        connect(tauSource.flange, sepExcDCM.flange) annotation(
          Line(points = {{44, 42}, {44, 0}}));
        annotation(
          Icon(graphics = {Bitmap(origin = {1, 3}, extent = {{89, -89}, {-89, 89}}, imageSource = ""), Text(origin = {-2, -224}, textColor = {0, 0, 255}, extent = {{-150, 70}, {150, 110}}, textString = "%name")}));
      end MotorControlTorque;

      model ControlledDCMotorPerturbance
        DSFLib.ControlSystems.Blocks.Components.Add add(k2 = -1) annotation(
        ...
        DSFLib.ControlSystems.Blocks.Components.Add add1 annotation(
          Placement(visible = true, transformation(origin = {32, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.ControlSystems.Examples.MotorControlTorque motor annotation(
          Placement(visible = true, transformation(origin = {78, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Components.StepSource torque(Ti = 2, U = -2500) annotation(
      ...
      equation
        connect(V0.y, add1.u2) annotation(
          Line(points = {{-16.4, -20}, {13.8, -20}, {13.8, -6}, {19.6, -6}}));
        connect(add1.y, motor.u) annotation(
          Line(points = {{44, -0.2}, {55, -0.2}}));
        connect(add.u2, motor.y) annotation(
          Line(points = {{-70, 0}, {-75.8, 0}, {-75.8, -44}, {110.2, -44}, {110.2, 0}, {102.2, 0}}));
        connect(torque.y, motor.p) annotation(
          Line(points = {{43.6, 38}, {77.2, 38}, {77.2, 24}}));
        connect(w0.y, add.u1) annotation(
          Line(points = {{-86.4, 12}, {-70, 12}}));
        connect(gain.y, integrator.u) annotation(
          Line(points = {{-16.2, 6}, {-10.2, 6}}));
        connect(gain.u, add.y) annotation(
          Line(points = {{-40, 6}, {-46, 6}}));
        connect(integrator.y, add1.u1) annotation(
          Line(points = {{14, 6}, {20, 6}}));
      protected
      end ControlledDCMotorPerturbance;
    end Examples;
  end ControlSystems;
...
Table")}));
  ...
  package PROBLEMAS
    package PROBLEMA_1
      model CommandedSwitch
        extends DSFLib.Circuits.Interfaces.OnePort;
        DSFLib.ControlSystems.Blocks.Interfaces.RealInput u annotation(
          Placement(visible = true, transformation(origin = {0, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-2.22045e-16, 60}, extent = {{-16, -16}, {16, 16}}, rotation = -90)));
        parameter Real Ron = 1e-5, Roff = 1e5;
      equation
        v = if u > 0.5 then i*Ron else i*Roff;
        annotation(
          Icon(graphics = {Line(origin = {-24.26, 21.76}, points = {{-61.741, -21.759}, {-17.741, -21.759}, {62.259, 22.241}, {-17.741, -21.759}}, color = {0, 0, 255}), Line(origin = {64, 0}, points = {{22, 0}, {-22, 0}, {-24, 0}}, color = {0, 0, 255}), Text(origin = {-2, -142}, textColor = {0, 0, 255}, extent = {{-150, 70}, {150, 110}}, textString = "%name")}));
      end CommandedSwitch;

      model Buck
        DSFLib.Circuits.Components.Ground ground annotation(
          Placement(visible = true, transformation(origin = {0, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Circuits.Components.Capacitor C(C = 1e-4) annotation(
          Placement(visible = true, transformation(origin = {24, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.Circuits.Components.Inductor L(L = 1e-4) annotation(
          Placement(visible = true, transformation(origin = {0, 24}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Circuits.Components.Diode D annotation(
          Placement(visible = true, transformation(origin = {-22, 0}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
        DSFLib.PROBLEMAS.PROBLEMA_1.CommandedSwitch Sw annotation(
          Placement(visible = true, transformation(origin = {-42, 24}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Circuits.Components.Resistor RL(R = 10) annotation(
          Placement(visible = true, transformation(origin = {52, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.Circuits.Components.ConstVolt Vin(V = 12) annotation(
          Placement(visible = true, transformation(origin = {-62, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        PulsePWM pulsePWM(T = 1e-4) annotation(
          Placement(visible = true, transformation(origin = {-76, 52}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(Sw.n, D.n) annotation(
          Line(points = {{-32, 24}, {-22, 24}, {-22, 10}}));
        connect(D.p, ground.p) annotation(
          Line(points = {{-22, -10}, {-22, -22}, {0, -22}}));
        connect(L.p, Sw.n) annotation(
          Line(points = {{-10, 24}, {-32, 24}}));
        connect(L.n, RL.p) annotation(
          Line(points = {{10, 24}, {52, 24}, {52, 10}}));
        connect(L.n, C.p) annotation(
          Line(points = {{10, 24}, {24, 24}, {24, 10}}));
        connect(C.n, ground.p) annotation(
          Line(points = {{24, -10}, {24, -22}, {0, -22}}));
        connect(RL.n, ground.p) annotation(
          Line(points = {{52, -10}, {52, -22}, {0, -22}}));
        connect(Sw.p, Vin.p) annotation(
          Line(points = {{-52, 24}, {-62, 24}, {-62, 10}}));
        connect(Vin.n, ground.p) annotation(
          Line(points = {{-62, -10}, {-62, -22}, {0, -22}}));
        connect(pulsePWM.y, Sw.u) annotation(
          Line(points = {{-64, 52}, {-42, 52}, {-42, 30}}));
      end Buck;

      block PulsePWM
        DSFLib.ControlSystems.Blocks.Interfaces.RealOutput y annotation(
          Placement(visible = true, transformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {116, -8.88178e-16}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
        parameter Real T(unit = "s") = 1, dutyCycle(unit = "%") = 50, t0(unit = "s") = 0, U = 1 "Amplitude";
        Real pulseStart;
      initial equation
        pulseStart = t0;
      equation
        if time >= pulseStart and time < pulseStart + T*dutyCycle/100 then
          y = U;
        else
          y = 0;
        end if;
      algorithm
        when sample(pulseStart, T) then
          pulseStart := time;
        end when;
        annotation(
          Icon(graphics = {Text(textColor = {0, 0, 255}, extent = {{-150, 150}, {150, 110}}, textString = "%name"), Text(extent = {{-147, -152}, {153, -112}}, textString = "T=%T"), Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, -100}, {100, 100}}), Line(origin = {0.811, -9.62207}, points = {{-80, 56}, {-36, 56}, {-36, -70}, {-18, -70}, {-18, 56}, {24, 56}, {24, -70}, {43, -70}}, thickness = 0.5), Text(origin = {0, -40}, extent = {{-147, -152}, {153, -112}}, textString = "dc=%dutyCycle"), Line(origin = {0, -10}, points = {{-80, 80}, {-80, -80}}, color = {95, 95, 95}), Line(origin = {0, -10}, points = {{-90, -70}, {82, -70}}, color = {95, 95, 95}), Polygon(lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid, points = {{-80, 90}, {-86, 68}, {-74, 68}, {-80, 90}}), Polygon(origin = {0, -10}, lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid, points = {{90, -70}, {68, -64}, {68, -76}, {90, -70}}), Line(origin = {56.406, -17}, points = {{-12, -63}, {-12, 63}, {12, 63}, {12, 63}}, thickness = 0.5)}));
      end PulsePWM;
    end PROBLEMA_1;
    ...
    package PROBLEMA_2
      model SineVoltage
        ...
        parameter DSFLib.Circuits.Units.Voltage Amplitude = 10, Offset = 0;
        parameter Real Phase(unit = "°") = 0;
      equation
        v = Amplitude*Modelica.Math.sin(2*Modelica.Constants.pi*Freq*time + 2*Modelica.Constants.pi*Phase/360) + Offset;
        annotation(
          Icon(graphics = {Line(points = {{-90, 0}, {90, 0}}, color = {0, 0, 255}), Line(points = {{-80, 20}, {-60, 20}}, color = {0, 0, 255}), Text(textColor = {0, 0, 255}, extent = {{-150, 60}, {150, 100}}, textString = "%name"), Line(points = {{-70, 30}, {-70, 10}}, color = {0, 0, 255}), Line(points = {{60, 20}, {80, 20}}, color = {0, 0, 255}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-50, 50}, {50, -50}}), Line(points = {{-66, 0}, {-56.2, 29.9}, {-49.8, 46.5}, {-44.2, 58.1}, {-39.3, 65.2}, {-34.3, 69.2}, {-29.4, 69.8}, {-24.5, 67}, {-19.6, 61}, {-14.6, 52}, {-9, 38.6}, {-1.98, 18.6}, {12.79, -26.9}, {19.1, -44}, {24.8, -56.2}, {29.7, -64}, {34.6, -68.6}, {39.5, -70}, {44.5, -67.9}, {49.4, -62.5}, {54.3, -54.1}, {59.9, -41.3}, {67, -21.7}, {74, 0}}, color = {192, 192, 192})}));
      end SineVoltage;

      partial model TwoPorts
        DSFLib.Circuits.Interfaces.Pin p1 annotation(
          Placement(visible = true, transformation(origin = {-100, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 80}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
        DSFLib.Circuits.Interfaces.Pin n1 annotation(
          Placement(visible = true, transformation(origin = {-100, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -80}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
        DSFLib.Circuits.Interfaces.Pin p2 annotation(
          Placement(visible = true, transformation(origin = {100, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 80}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
        DSFLib.Circuits.Interfaces.Pin n2 annotation(
          Placement(visible = true, transformation(origin = {100, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -80}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
        DSFLib.Circuits.Units.Voltage v1, v2;
        DSFLib.Circuits.Units.Current i1, i2;
      equation
        v1 = p1.v - n1.v;
        p1.i = i1;
        n1.i + p1.i = 0;
      ...
      model Transformer
        extends DSFLib.PROBLEMAS.PROBLEMA_2.TwoPorts;
        parameter Real L1 = 1, L2 = 1, M = 1;
      equation
        v1 = L1*der(i1) + M*der(i2);
        v2 = M*der(i1) + L2*der(i2);
        annotation(
          Icon(graphics = {Line(origin = {-39.8908, -0.499914}, rotation = -90, points = {{60, 0}, {80, 0}}, color = {0, 0, 255}), Line(origin = {-39.8908, -0.499914}, rotation = -90, points = {{30, 0}, {31, 6}, {38, 14}, {52, 14}, {59, 6}, {60, 0}}, color = {0, 0, 255}, smooth = Smooth.Bezier), Line(origin = {-39.8908, -0.499914}, rotation = -90, points = {{0, 0}, {1, 6}, {8, 14}, {22, 14}, {29, 6}, {30, 0}}, color = {0, 0, 255}, smooth = Smooth.Bezier), Line(origin = {-39.8908, -0.499914}, rotation = -90, points = {{-60, 0}, {-59, 6}, {-52, 14}, {-38, 14}, {-31, 6}, {-30, 0}}, color = {0, 0, 255}, smooth = Smooth.Bezier), Line(origin = {6.67036, -0.59}, rotation = -90, points = {{-50, 0}, {50, 0}}, color = {0, 0, 255}), Line(origin = {-39.8908, -0.499914}, rotation = -90, points = {{-80, 0}, {-60, 0}}, color = {0, 0, 255}), Line(origin = {-6.8296, -0.85}, rotation = -90, points = {{-50, 0}, {50, 0}}, color = {0, 0, 255}), Line(origin = {-39.8908, -0.499914}, rotation = -90, points = {{-30, 0}, {-29, 6}, {-22, 14}, {-8, 14}, {-1, 6}, {0, 0}}, color = {0, 0, 255}, smooth = Smooth.Bezier), Line(origin = {40.1092, -0.499914}, rotation = 90, points = {{30, 0}, {31, 6}, {38, 14}, {52, 14}, {59, 6}, {60, 0}}, color = {0, 0, 255}, smooth = Smooth.Bezier), Line(origin = {40.1092, -0.499914}, rotation = 90, points = {{-60, 0}, {-59, 6}, {-52, 14}, {-38, 14}, {-31, 6}, {-30, 0}}, color = {0, 0, 255}, smooth = Smooth.Bezier), Line(origin = {40.1092, -0.499914}, rotation = 90, points = {{60, 0}, {80, 0}}, color = {0, 0, 255}), Line(origin = {40.1092, -0.499914}, rotation = 90, points = {{-30, 0}, {-29, 6}, {-22, 14}, {-8, 14}, {-1, 6}, {0, 0}}, color = {0, 0, 255}, smooth = Smooth.Bezier), Line(origin = {40.1092, -0.499914}, rotation = 90, points = {{-80, 0}, {-60, 0}}, color = {0, 0, 255}), Line(origin = {40.1092, -0.499914}, rotation = 90, points = {{0, 0}, {1, 6}, {8, 14}, {22, 14}, {29, 6}, {30, 0}}, color = {0, 0, 255}, smooth = Smooth.Bezier), Line(origin = {-69.87, 79.62}, points = {{-30, 0}, {30, 0}, {30, 0}}, color = {0, 0, 255}), Line(origin = {69.13, 79.62}, points = {{-29, 0}, {29, 0}, {29, 0}}, color = {0, 0, 255}), Line(origin = {-69.9, -80.51}, points = {{-30, 0}, {30, 0}, {30, 0}}, color = {0, 0, 255}), Line(origin = {69.1277, -80.5109}, points = {{-29, 0}, {29, 0}, {29, 0}}, color = {0, 0, 255}), Text(origin = {0, 56}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name")}));
      end Transformer;

      model RMMO
        DSFLib.PROBLEMAS.PROBLEMA_2.SineVoltage sineVoltage(Amplitude = 220*sqrt(2), Freq = 50) annotation(
          Placement(visible = true, transformation(origin = {-48, 2}, extent = {{10, -10}, {-10, 10}}, rotation = 90)));
        DSFLib.Circuits.Components.Resistor Rs(R = 0.2) annotation(
          Placement(visible = true, transformation(origin = {-30, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Circuits.Components.Resistor RL annotation(
          Placement(visible = true, transformation(origin = {48, 2}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.Circuits.Components.Diode diode(Vknee = 0.6) annotation(
          Placement(visible = true, transformation(origin = {30, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Circuits.Components.Ground ground annotation(
          Placement(visible = true, transformation(origin = {0, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_2.Transformer transformer(L1 = 1, L2 = 1, M = 1) annotation(
          Placement(visible = true, transformation(origin = {0, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(diode.n, RL.p) annotation(
          Line(points = {{40, 20}, {48, 20}, {48, 12}}));
        connect(sineVoltage.p, Rs.p) annotation(
          Line(points = {{-48, 12}, {-48, 20}, {-40, 20}}));
        connect(sineVoltage.n, ground.p) annotation(
          Line(points = {{-48, -8}, {-48, -20}, {0, -20}}));
        connect(RL.n, ground.p) annotation(
          Line(points = {{48, -8}, {48, -20}, {0, -20}}));
        connect(Rs.n, transformer.p1) annotation(
          Line(points = {{-20, 20}, {-14, 20}, {-14, 10}, {-10, 10}}));
        connect(transformer.p2, diode.p) annotation(
          Line(points = {{10, 10}, {14, 10}, {14, 20}, {20, 20}}));
        connect(transformer.n1, ground.p) annotation(
          Line(points = {{-10, -6}, {-14, -6}, {-14, -20}, {0, -20}}));
        connect(transformer.n2, ground.p) annotation(
          Line(points = {{10, -6}, {14, -6}, {14, -20}, {0, -20}}));
      end RMMO;
    end PROBLEMA_2;
    ...
    package PROBLEMA_3
      model Palanca
        DSFLib.Mechanical.Translational.Interfaces.Flange flange_b annotation(
          Placement(visible = true, transformation(origin = {-100, -38}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -18}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Interfaces.Flange flange_c annotation(
          Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 0}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Interfaces.Flange flange_a annotation(
          Placement(visible = true, transformation(origin = {100, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 17.5}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
        parameter Real L1 = 1, L2 = 1;
      equation
        (flange_b.s - flange_c.s)*L1 = (flange_c.s - flange_a.s)*L2;
        L2*flange_b.f - L1*flange_a.f = 0;
        flange_b.f + flange_a.f + flange_c.f = 0;
        annotation(
          Icon(graphics = {Rectangle(origin = {1, 0}, rotation = 10.05, fillColor = {0, 170, 0}, fillPattern = FillPattern.Solid, extent = {{-102, 8}, {102, -8}}), Ellipse(origin = {100, 17.5}, fillColor = {0, 170, 0}, fillPattern = FillPattern.Solid, extent = {{-8, 8}, {8, -8}}), Ellipse(origin = {-100, -18}, fillColor = {0, 170, 0}, fillPattern = FillPattern.Solid, extent = {{-8, 8}, {8, -8}})}));
      end Palanca;

      model SistPalanca
        DSFLib.Mechanical.Translational.Components.Fixed fixed annotation(
          Placement(visible = true, transformation(origin = {-2, -16}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.Mass mass annotation(
          Placement(visible = true, transformation(origin = {22, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.Damper damper(b = 5) annotation(
          Placement(visible = true, transformation(origin = {-26, 12}, extent = {{-8, -8}, {8, 8}}, rotation = -90)));
        DSFLib.Mechanical.Translational.Components.Spring spring(k = 1000) annotation(
          Placement(visible = true, transformation(origin = {22, 12}, extent = {{-8, -8}, {8, 8}}, rotation = -90)));
        ...
        DSFLib.Mechanical.Translational.Components.Fixed fixed2 annotation(
          Placement(visible = true, transformation(origin = {-26, 30}, extent = {{-8, 8}, {8, -8}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.ConstForce GravityForce(F = -9.8) annotation(
          Placement(visible = true, transformation(origin = {22, -50}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.PROBLEMAS.PROBLEMA_3.Palanca palanca annotation(
          Placement(visible = true, transformation(origin = {-2, -8}, extent = {{-24, -24}, {24, 24}}, rotation = 0)));
      equation
        connect(fixed2.flange, damper.flange_a) annotation(
          Line(points = {{-26, 30}, {-26, 20}}));
        connect(mass.flange, GravityForce.flange) annotation(
          Line(points = {{22, -28}, {22, -40}}));
        connect(palanca.flange_c, fixed.flange) annotation(
          Line(points = {{-2, -8}, {-2, -16}}));
        connect(damper.flange_b, palanca.flange_b) annotation(
          Line(points = {{-26, 4}, {-26, -12}}));
        connect(palanca.flange_a, mass.flange) annotation(
          Line(points = {{22, -4}, {22, -28}}));
        connect(fixed1.flange, spring.flange_a) annotation(
          Line(points = {{22, 30}, {22, 20}}));
        connect(spring.flange_b, palanca.flange_a) annotation(
          Line(points = {{22, 4}, {22, -4}}));
      end SistPalanca;
    end PROBLEMA_3;
    ...
    package PROBLEMA_4
      model Polea
        ...
        parameter Real S0(unit = "m"), r(unit = "m") = 1;
      equation
        S0 = (flange_a.s + flange_b.s)/2;
        r*flange_r.phi = (flange_b.s - flange_a.s)/2;
        r*flange_a.f - r*flange_b.f = flange_r.tau;
        annotation(
          Icon(graphics = {Ellipse(lineColor = {30, 30, 30}, fillColor = {231, 231, 231}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, 100}, {100, -100}}), Text(origin = {87, 111}, extent = {{-31, 17}, {31, -17}}, textString = "r=%r"), Ellipse(fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, extent = {{-84, 84}, {84, -84}}), Line(origin = {27.3623, 41.6379}, points = {{-27, -42}, {27, 42}, {27, 42}}, pattern = LinePattern.Dash), Polygon(origin = {49, 77}, fillPattern = FillPattern.Solid, points = {{5, 7}, {-5, -3}, {1, -7}, {1, -7}, {1, -7}, {5, 7}}), Ellipse(extent = {{-14, 14}, {14, -14}}), Ellipse(lineColor = {40, 40, 40}, fillColor = {234, 234, 234}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-34, 34}, {34, -34}})}));
      end Polea;

      model SistPolea
        DSFLib.Mechanical.Translational.Components.Spring spring(k = 500) annotation(
          Placement(visible = true, transformation(origin = {-26, -20}, extent = {{-8, -8}, {8, 8}}, rotation = 90)));
        DSFLib.Mechanical.Translational.Components.Fixed fixed annotation(
          Placement(visible = true, transformation(origin = {-26, -46}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
        DSFLib.Mechanical.Rotational.Components.Damper damper(b = 0.05) annotation(
          Placement(visible = true, transformation(origin = {6, 56}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Mechanical.Rotational.Components.Inertia inertia(J = 1e-3) annotation(
          Placement(visible = true, transformation(origin = {20, 32}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
        DSFLib.Mechanical.Rotational.Components.Fixed fixed1 annotation(
          Placement(visible = true, transformation(origin = {38, 56}, extent = {{8, -8}, {-8, 8}}, rotation = 90)));
        DSFLib.Mechanical.Translational.Components.ConstForce gravityForce(F = -9.8*0.5) annotation(
          Placement(visible = true, transformation(origin = {-2, -56}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.Mechanical.Translational.Components.Mass mass(m = 0.5) annotation(
          Placement(visible = true, transformation(origin = {-2, -32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_4.Polea polea(r = 0.08) annotation(
          Placement(visible = true, transformation(origin = {-14, 12}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
      equation
        connect(damper.flange_b, fixed1.flange) annotation(
          Line(points = {{15.9, 55.9}, {37.9, 55.9}}));
        connect(spring.flange_a, fixed.flange) annotation(
          Line(points = {{-26, -28}, {-26, -46}}));
        connect(mass.flange, gravityForce.flange) annotation(
          Line(points = {{-2, -32}, {-2, -46}}));
        connect(polea.flange_a, spring.flange_b) annotation(
          Line(points = {{-26, 12}, {-26, -12}}));
        connect(polea.flange_b, mass.flange) annotation(
          Line(points = {{-2, 12}, {-2, -32}}));
        connect(damper.flange_a, polea.flange_r) annotation(
          Line(points = {{-4, 56}, {-14, 56}, {-14, 12}}));
        connect(inertia.flange, polea.flange_r) annotation(
          Line(points = {{12, 32}, {-14, 32}, {-14, 12}}));
        annotation(
          Diagram);
      end SistPolea;
    end PROBLEMA_4;
    ...
    package PROBLEMA_5
      model Biela
        DSFLib.Mechanical.Rotational.Interfaces.Flange flange_r annotation(
          Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-60, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Interfaces.Flange flange_a annotation(
        ...
        parameter Real r(unit = "m") = 1, L(unit = "m") = 1, S0(unit = "m") = 0;
        Real phi(stateSelect = StateSelect.prefer), omega;
      equation
        flange_a.s = r*Modelica.Math.cos(flange_r.phi) + L*sqrt(1 - ((r/L)*Modelica.Math.sin(flange_r.phi))^2) + S0;
        flange_r.tau*(flange_a.s - r*Modelica.Math.cos(flange_r.phi)) = flange_a.f*r*flange_a.s*Modelica.Math.sin(flange_r.phi);
        phi = flange_r.phi;
        der(phi) - omega = 0;
        annotation(
          Icon(graphics = {Text(origin = {49, 39}, extent = {{-23, 19}, {23, -19}}, textString = "L=%L"), Text(origin = {8, -70}, extent = {{-22, 18}, {22, -18}}, textString = "r=%r"), Ellipse(origin = {-60, -1}, lineColor = {30, 30, 30}, fillColor = {231, 231, 231}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-68, 67}, {68, -67}}), Ellipse(origin = {-60, -1}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, extent = {{-58, 57}, {58, -57}}), Ellipse(origin = {-60, 0}, lineColor = {40, 40, 40}, fillColor = {234, 234, 234}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-16, 16}, {16, -16}}), Line(origin = {69.5, -10}, points = {{-13.5, 0}, {14.5, 0}, {12.5, 0}}), Line(origin = {69.5, 10}, points = {{-13.5, 0}, {14.5, 0}, {12.5, 0}}), Polygon(origin = {35, 23}, fillColor = {0, 170, 0}, fillPattern = FillPattern.Solid, points = {{-53, 29}, {7, -17}, {59, -17}, {59, -29}, {3, -29}, {-59, 21}, {-53, 29}, {-53, 29}}), Ellipse(origin = {-17, 45}, fillPattern = FillPattern.Solid, extent = {{-3, 3}, {3, -3}}), Ellipse(origin = {-17, 45}, extent = {{-5, 5}, {5, -5}}), Ellipse(origin = {39, 1}, extent = {{-5, 5}, {5, -5}}), Ellipse(origin = {39, 1}, fillPattern = FillPattern.Solid, extent = {{-3, 3}, {3, -3}})}));
      end Biela;

      model BielaManivela
        DSFLib.Mechanical.Translational.Components.Damper damper(b = 1) annotation(
          Placement(visible = true, transformation(origin = {49, -11}, extent = {{-11, 11}, {11, -11}}, rotation = 180)));
        DSFLib.Mechanical.Rotational.Components.Inertia inertia(J = 0.01, w(start = 0.1)) annotation(
          Placement(visible = true, transformation(origin = {-80, 0}, extent = {{12, -12}, {-12, 12}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.Mass mass annotation(
          Placement(visible = true, transformation(origin = {10, -1.33227e-15}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.Spring spring(k = 100, s_rel0 = 0.5) annotation(
          Placement(visible = true, transformation(origin = {49, 13}, extent = {{-11, 11}, {11, -11}}, rotation = -180)));
        DSFLib.Mechanical.Translational.Components.Fixed fixed annotation(
          Placement(visible = true, transformation(origin = {78, -8.88178e-16}, extent = {{12, -12}, {-12, 12}}, rotation = 90)));
        DSFLib.PROBLEMAS.PROBLEMA_5.Biela biela(r = 0.1) annotation(
          Placement(visible = true, transformation(origin = {-32, -1.77636e-15}, extent = {{-22, -22}, {22, 22}}, rotation = 0)));
      equation
        connect(biela.flange_a, mass.flange) annotation(
          Line(points = {{-10, -1.77636e-15}, {10, -1.77636e-15}}));
        connect(inertia.flange, biela.flange_r) annotation(
          Line(points = {{-68.24, -1.06581e-16}, {-57.98, -1.06581e-16}, {-57.98, -2.13162e-16}, {-45.48, -2.13162e-16}}));
        connect(spring.flange_a, fixed.flange) annotation(
          Line(points = {{60, 13}, {68, 13}, {68, -1.77636e-15}, {78, -1.77636e-15}}));
        connect(damper.flange_a, fixed.flange) annotation(
          Line(points = {{60, -11}, {68, -11}, {68, -1.77636e-15}, {78, -1.77636e-15}}));
        connect(spring.flange_b, mass.flange) annotation(
          Line(points = {{38, 13}, {30, 13}, {30, -1.77636e-15}, {10, -1.77636e-15}}));
        connect(damper.flange_b, mass.flange) annotation(
          Line(points = {{38, -11}, {30, -11}, {30, -1.77636e-15}, {10, -1.77636e-15}}));
        annotation(
          Diagram(graphics = {Line(origin = {-32.4742, 23.0809}, rotation = -90, points = {{0, -12.5}, {0, 51.5}, {0, 51.5}}), Text(origin = {29, 30}, extent = {{-5, 4}, {5, -4}}, textString = "s"), Polygon(origin = {22, 23.2}, rotation = -90, fillPattern = FillPattern.Solid, points = {{0, 4}, {-2, -4}, {2, -4}, {0, 4}, {0, 4}}), Line(origin = {-44.9274, 21.0595}, rotation = -90, points = {{-6, 0}, {-2, 0}, {2, 0}})}));
      end BielaManivela;
    end PROBLEMA_5;
    ...
    package PROBLEMA_7
      model PuenteGrua
        ...
        DSFLib.Mechanical.Translational.Components.Damper damper annotation(
          Placement(visible = true, transformation(origin = {-60, 24}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
        DSFLib.Mechanical.Planar.Components.Prismatic prismatic annotation(
        ...
        DSFLib.PROBLEMAS.PROBLEMA_7.ConstSpeedSource constSpeedSource(w = -0.5) annotation(
          Placement(visible = true, transformation(origin = {-54, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Mechanical.Planar.Components.pointMass M(m = 1e3) annotation(
          Placement(visible = true, transformation(origin = {4, -54}, extent = {{10, -10}, {-10, 10}}, rotation = 90)));
        DSFLib.Mechanical.Planar.Components.pointMass m(m = 250) annotation(
          Placement(visible = true, transformation(origin = {4, 44}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.ConstForce Fx(F = 1000) annotation(
          Placement(visible = true, transformation(origin = {-24, 24}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DSFLib.Mechanical.Planar.Components.Prismatic prismatic1 annotation(
          Placement(visible = true, transformation(origin = {4, -20}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  DSFLib.Mechanical.RotoTranslational.Components.RetractableCord retractableCord(r = 0.01)  annotation(
          Placement(visible = true, transformation(origin = {-26, -20}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      equation
        connect(prismatic.flange_a, damper.flange_b) annotation(
          Line(points = {{-53.6, 37.8}, {-53.6, 31.8}, {-45.6, 31.8}, {-45.6, 24}, {-52, 24}}));
        connect(prismatic.support, damper.flange_a) annotation(
          Line(points = {{-66.4, 37.8}, {-66.4, 31.8}, {-74.4, 31.8}, {-74.4, 24}, {-68, 24}}));
        connect(fixed.frame, prismatic.frame_a) annotation(
          Line(points = {{-81.6, 44}, {-69.6, 44}}));
        connect(prismatic.frame_b, m.frame) annotation(
          Line(points = {{-50, 44}, {4.8, 44}}));
        connect(m.frame, revolute.frame_a) annotation(
          Line(points = {{4, 44}, {4, 22}}));
        connect(damper.flange_b, Fx.flange) annotation(
          Line(points = {{-52, 24}, {-34, 24}}));
  connect(constSpeedSource.flange, retractableCord.flange_r) annotation(
          Line(points = {{-44, -18}, {-26, -18}}));
  connect(revolute.frame_b, prismatic1.frame_a) annotation(
          Line(points = {{4, 2}, {4, -10}}));
  connect(prismatic1.frame_b, M.frame) annotation(
          Line(points = {{4, -30}, {4, -54}}));
  connect(retractableCord.flange_a, prismatic1.support) annotation(
          Line(points = {{-26, -10}, {-26, -4}, {-8, -4}, {-8, -14}, {-2, -14}}));
  connect(retractableCord.flange_b, prismatic1.flange_a) annotation(
          Line(points = {{-26, -30}, {-26, -36}, {-8, -36}, {-8, -26}, {-2, -26}}));
        annotation(
          Diagram(graphics = {Polygon(origin = {74, 64}, fillPattern = FillPattern.Solid, points = {{0, 4}, {-2, -4}, {2, -4}, {0, 4}, {0, 4}}), Line(origin = {75.9942, 43.6183}, points = {{-6, 0}, {-2, 0}, {2, 0}}), Line(origin = {74.0662, 56.1176}, points = {{0, -12.5}, {0, 9.5}, {0, 9.5}}), Text(origin = {81, 68}, extent = {{-5, 4}, {5, -4}}, textString = "y"), Text(origin = {37, 70}, extent = {{-5, 4}, {5, -4}}, textString = "x"), Line(origin = {5.18973, 62.0049}, rotation = -90, points = {{-6, 0}, {-2, 0}, {2, 0}}), Line(origin = {17.643, 64.0263}, rotation = -90, points = {{0, -12.5}, {0, 13.5}, {0, 9.5}}), Polygon(origin = {29, 64.5}, rotation = -90, fillPattern = FillPattern.Solid, points = {{0, 4}, {-2, -4}, {2, -4}, {0, 4}, {0, 4}})}));
      end PuenteGrua;

      model ConstSpeedSource
        DSFLib.Mechanical.Rotational.Interfaces.Flange flange annotation(
          Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -2.22045e-16}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
        parameter Real w(unit = "rad/s") = 1;
      equation
        w = der(flange.phi);
        annotation(
          Icon(graphics = {Line(points = {{0, -32}, {0, -100}}), Line(points = {{-30, -32}, {30, -32}}), Line(points = {{-30, -100}, {30, -100}}), Text(textColor = {0, 0, 255}, extent = {{-150, 60}, {150, 100}}, textString = "%name"), Line(points = {{-29, 32}, {30, 32}}), Line(points = {{-10, -120}, {10, -100}}), Line(points = {{-50, -120}, {-30, -100}}), Line(points = {{0, 52}, {0, 32}}), Rectangle(lineColor = {64, 64, 64}, fillColor = {192, 192, 192}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, -20}, {100, 20}}), Line(points = {{-30, -120}, {-10, -100}}), Line(points = {{10, -120}, {30, -100}}), Text(origin = {4, -60}, extent = {{150, -96}, {-150, -66}}, textString = "w=%w")}));
      end ConstSpeedSource;
    end PROBLEMA_7;

    package PROBLEMA_8
      model Tanque
        DSFLib.Hydraulics.Components.ConstPress ATM annotation(
        ...
        DSFLib.Hydraulics.Components.ConstPress constPress annotation(
          Placement(visible = true, transformation(origin = {58, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
        DSFLib.Hydraulics.Components.IdealPump idealPump annotation(
          Placement(visible = true, transformation(origin = {-42, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Hydraulics.Components.Tank tank annotation(
          Placement(visible = true, transformation(origin = {-2.22045e-16, 36}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
        DSFLib.Hydraulics.Components.Valve valve(RH = 1e8) annotation(
          Placement(visible = true, transformation(origin = {24, -34}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
      equation
        connect(tank.fluidPort, column.fluidPort_a) annotation(
          Line(points = {{-2.57572e-16, 20}, {-2.57572e-16, -4}}));
        connect(ATM.fluidPort, idealPump.fluidPort_a) annotation(
          Line(points = {{-66, 10}, {-52, 10}}));
        connect(valve.fluidPort_a, column.fluidPort_b) annotation(
          Line(points = {{16, -34}, {0, -34}, {0, -24}}));
        connect(valve.fluidPort_b, constPress.fluidPort) annotation(
          Line(points = {{32, -34}, {48, -34}}));
        connect(idealPump.fluidPort_b, tank.fluidPort) annotation(
          Line(points = {{-32, 10}, {0, 10}, {0, 20}}));
      end Tanque;
    end PROBLEMA_8;
    ...
    package PROBLEMA_9
      model Radiation
        extends DSFLib.Thermal.Interfaces.TwoPort;
        parameter Real G(unit = "m^-2") = 1;
      protected
        constant Real sigma = 5.68e-8;
      equation
        q = G*sigma*(heatPort_b.T^4 - heatPort_a.T^4);
        annotation(
          Icon(graphics = {Rectangle(origin = {-69, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, extent = {{-11, 100}, {11, -100}}), Rectangle(origin = {69, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, extent = {{-11, 100}, {11, -100}}), Polygon(origin = {26, 61}, lineColor = {255, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, points = {{-20, 13}, {20, 1}, {-20, -11}, {-20, 13}}), Polygon(origin = {19, 62}, lineColor = {255, 0, 0}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, lineThickness = 0, points = {{-13, 6}, {13, 0}, {-13, -6}, {-13, 6}, {-13, 6}}), Line(origin = {-30.4138, 62.0517}, points = {{-16, 0}, {70, 0}}, color = {255, 0, 0}), Polygon(origin = {-21, 20}, rotation = 180, lineColor = {255, 0, 0}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, lineThickness = 0, points = {{-13, 6}, {13, 0}, {-13, -6}, {-13, 6}, {-13, 6}}), Polygon(origin = {-28, 21}, rotation = 180, lineColor = {255, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, points = {{-20, 13}, {20, 1}, {-20, -11}, {-20, 13}}), Polygon(origin = {-21, 20}, rotation = 180, lineColor = {255, 0, 0}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, lineThickness = 0, points = {{-13, 6}, {13, 0}, {-13, -6}, {-13, 6}, {-13, 6}}), Line(origin = {23.5345, 20.0517}, rotation = 180, points = {{-16, 0}, {70, 0}}, color = {255, 0, 0}), Polygon(origin = {-21, -64}, rotation = 180, lineColor = {255, 0, 0}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, lineThickness = 0, points = {{-13, 6}, {13, 0}, {-13, -6}, {-13, 6}, {-13, 6}}), Polygon(origin = {-28, -63}, rotation = 180, lineColor = {255, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, points = {{-20, 13}, {20, 1}, {-20, -11}, {-20, 13}}), Polygon(origin = {26, -23}, lineColor = {255, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, points = {{-20, 13}, {20, 1}, {-20, -11}, {-20, 13}}), Polygon(origin = {-21, -64}, rotation = 180, lineColor = {255, 0, 0}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, lineThickness = 0, points = {{-13, 6}, {13, 0}, {-13, -6}, {-13, 6}, {-13, 6}}), Polygon(origin = {19, -22}, lineColor = {255, 0, 0}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, lineThickness = 0, points = {{-13, 6}, {13, 0}, {-13, -6}, {-13, 6}, {-13, 6}}), Line(origin = {23.5345, -63.9483}, rotation = 180, points = {{-16, 0}, {70, 0}}, color = {255, 0, 0}), Line(origin = {-30.4138, -21.9483}, points = {{-16, 0}, {70, 0}}, color = {255, 0, 0}), Text(origin = {0, -72}, extent = {{-150, -45}, {150, -75}}, textString = "G=%G"), Text(origin = {0, 74}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name")}));
      end Radiation;
      ...
      model Radiacion
        ...
        DSFLib.Thermal.Components.ThermalResistor thermalResistor1 annotation(
          Placement(visible = true, transformation(origin = {36, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_9.Radiation radiation annotation(
          Placement(visible = true, transformation(origin = {-14, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(heatFlowSource.heatPort, heatCapacitor.heatPort) annotation(
          Line(points = {{-60, 0}, {-40, 0}, {-40, 12}}));
        connect(thermalResistor.heatPort_b, heatFlowSource.heatPort) annotation(
          Line(points = {{-24, 0}, {-60, 0}}));
        connect(thermalResistor.heatPort_a, thermalResistor1.heatPort_b) annotation(
          Line(points = {{-4, 0}, {26, 0}}));
        connect(thermalResistor1.heatPort_a, constTemp.heatPort) annotation(
          Line(points = {{46, 8.88178e-17}, {56, 8.88178e-17}, {56, 0}, {60, 0}}));
        connect(heatCapacitor1.heatPort, thermalResistor.heatPort_a) annotation(
          Line(points = {{12, 12}, {12, 0}, {-4, 0}}));
        connect(radiation.heatPort_b, heatCapacitor.heatPort) annotation(
          Line(points = {{-24, -34}, {-40, -34}, {-40, 12}}));
        connect(radiation.heatPort_a, heatCapacitor1.heatPort) annotation(
          Line(points = {{-4, -34}, {12, -34}, {12, 12}}));
      end Radiacion;
    end PROBLEMA_9;
    ...
    package PROBLEMA_10
      model Carga
        DSFLib.Mechanical.Translational.Interfaces.Flange flange annotation(
          Placement(visible = true, transformation(origin = {0, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {1.55431e-15, 100}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.Mass m(m = 50) annotation(
          Placement(visible = true, transformation(origin = {0, -40}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.Spring spring(k = 1e4) annotation(
        ...
        DSFLib.Mechanical.Translational.Components.Mass M(m = 150) annotation(
          Placement(visible = true, transformation(origin = {42, 52}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));
        DSFLib.Mechanical.Translational.Components.ConstForce w_M(F = -9.8*150) annotation(
          Placement(visible = true, transformation(origin = {93, 19}, extent = {{-17, -17}, {17, 17}}, rotation = -90)));
        DSFLib.Mechanical.Translational.Components.ConstForce w_m(F = -9.8*50) annotation(
          Placement(visible = true, transformation(origin = {0, -80}, extent = {{-14, -14}, {14, 14}}, rotation = -90)));
      equation
        connect(flange, m.flange) annotation(
          Line(points = {{0, 100}, {0, -40}}));
        connect(w_m.flange, m.flange) annotation(
          Line(points = {{-2.17603e-16, -66}, {-2.17603e-16, -40}}));
        connect(M.flange, w_M.flange) annotation(
          Line(points = {{42, 52}, {93, 52}, {93, 36}}));
        connect(damper.flange_b, M.flange) annotation(
          Line(points = {{58, 10}, {58, 26}, {42, 26}, {42, 52}}));
        connect(m.flange, damper.flange_a) annotation(
          Line(points = {{0, -40}, {42, -40}, {42, -28}, {58, -28}, {58, -10}}));
        connect(spring.flange_a, M.flange) annotation(
          Line(points = {{28, 10}, {28, 26}, {42, 26}, {42, 52}}));
        connect(spring.flange_b, m.flange) annotation(
          Line(points = {{28, -10}, {28, -28}, {42, -28}, {42, -40}, {0, -40}}));
        annotation(
          Icon(graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-80, 80}, {80, -80}}), Rectangle(origin = {0, 18}, extent = {{-60, 26}, {60, -26}}), Line(origin = {-34.16, -75.68}, rotation = -90, points = {{-68, 0}, {-58, 0}, {-50, -18}, {-38, 16}, {-24, -18}, {-14, 16}, {-6, 0}, {4, 0}}, color = {0, 127, 0}), Line(visible = false, origin = {24.6687, -5.37651}, rotation = -90, points = {{-100, -100}, {-100, -20}, {-14, -20}}, color = {191, 0, 0}, pattern = LinePattern.Dot), Rectangle(origin = {30, -39}, lineColor = {0, 127, 0}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid, extent = {{-10, 19}, {10, -19}}), Line(origin = {20.03, -64.86}, points = {{0, 7}, {0, -7}, {0, -7}}, color = {0, 127, 0}), Line(origin = {40.03, -64.86}, points = {{0, 7}, {0, -7}, {0, -7}}, color = {0, 127, 0}), Line(origin = {30, -14}, points = {{0, -6}, {0, 6}, {0, 6}}, color = {0, 127, 0}), Line(origin = {30, -64}, points = {{0, -16}, {0, 6}, {0, 6}}, color = {0, 127, 0}), Text(origin = {0, 20}, extent = {{-38, 14}, {38, -14}}, textString = "M"), Text(origin = {-67, -38}, extent = {{-13, 12}, {13, -12}}, textString = "k"), Text(origin = {65, -38}, extent = {{-13, 12}, {13, -12}}, textString = "b"), Text(origin = {115, 114}, extent = {{-13, 12}, {13, -12}}, textString = "m")}));
      end Carga;

      model Montacargas
        DSFLib.Mechanical.Translational.Components.Fixed fixed annotation(
          Placement(visible = true, transformation(origin = {0, 52}, extent = {{-18, -18}, {18, 18}}, rotation = 180)));
        DSFLib.PROBLEMAS.PROBLEMA_10.Carga carga(M(s(start = 9.853000023860121))) annotation(
          Placement(visible = true, transformation(origin = {0, -50}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_10.Motor motor annotation(
          Placement(visible = true, transformation(origin = {-48, 14}, extent = {{-28, -28}, {28, 28}}, rotation = 0)));
  DSFLib.Mechanical.RotoTranslational.Components.RetractableCord retractableCord1(L0 = 10, r = 0.05)  annotation(
          Placement(visible = true, transformation(origin = {1.11022e-15, 6}, extent = {{-18, -18}, {18, 18}}, rotation = -90)));
      equation
        connect(fixed.flange, retractableCord1.flange_a) annotation(
          Line(points = {{0, 52}, {0, 24}}));
  connect(retractableCord1.flange_b, carga.flange) annotation(
          Line(points = {{0, -12}, {0, -32}}));
  connect(motor.flange, retractableCord1.flange_r) annotation(
          Line(points = {{-22, 10}, {0, 10}}));
        annotation(
          Diagram(graphics = {Line(origin = {32.3598, 49.2226}, points = {{0, -12.5}, {0, 9.5}, {0, 9.5}}), Polygon(origin = {32.5, 36}, rotation = 180, fillPattern = FillPattern.Solid, points = {{0, 4}, {-2, -4}, {2, -4}, {0, 4}, {0, 4}}), Text(origin = {41, 34}, extent = {{-5, 4}, {5, -4}}, textString = "s"), Line(origin = {34.1775, 58.8728}, points = {{-6, 0}, {-2, 0}, {2, 0}})}));
      end Montacargas;

      model Motor
        DSFLib.Mechanical.Rotational.Interfaces.Flange flange annotation(
          Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {90, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Circuits.Components.ConstVolt Vexc(V = 184) annotation(
          Placement(visible = true, transformation(origin = {-51, -1}, extent = {{-11, -11}, {11, 11}}, rotation = -90)));
        Mechanical.Rotational.Components.Damper damper(b = 1) annotation(
          Placement(visible = true, transformation(origin = {44, -48}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        Circuits.Components.Ground ground annotation(
          Placement(visible = true, transformation(origin = {-27, -41}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
        MultiDomain.ElectroMechanical.Components.SepExcDCM sepExcDCM(K = 0.016, currTable = {0, 1.5, 3, 4.5, 6, 9, 10, 12, 13.5, 14.5, 15}, flange(phi(start = 0)), fluxTable = {0, 100, 200, 300, 370, 470, 500, 520, 539, 540}, phi0 = 413.385996015012) annotation(
          Placement(visible = true, transformation(origin = {12, 0}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
        Mechanical.Rotational.Components.Fixed fixed annotation(
          Placement(visible = true, transformation(origin = {44, -74}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Mechanical.Rotational.Components.Inertia inertia(J = 15, w(start = 0)) annotation(
          Placement(visible = true, transformation(origin = {66, 0}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
        Circuits.Components.Resistor Rexc(R = 25.2) annotation(
          Placement(visible = true, transformation(origin = {-27, 23}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
        Circuits.Components.Inductor La(L = 0.003, i(start = 0)) annotation(
          Placement(visible = true, transformation(origin = {-7, 45}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
        Circuits.Components.Resistor Ra(R = 0.05) annotation(
          Placement(visible = true, transformation(origin = {-47, 45}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
        ...
        DSFLib.ControlSystems.Blocks.Components.RampSource rampSource(U = -460, t0 = 0, tf = 4) annotation(
      ...
      equation
        ...
        connect(damper.flange_b, fixed.flange) annotation(
          Line(points = {{44, -58}, {44, -74}}));
        connect(inertia.flange, flange) annotation(
          Line(points = {{54, 0}, {100, 0}}));
        connect(Va.p, Ra.p) annotation(
          Line(points = {{-80, 10}, {-80, 46}, {-58, 46}}));
        connect(Va.n, ground.p) annotation(
          Line(points = {{-80, -10}, {-80, -32}, {-26, -32}}));
        connect(rampSource.y, Va.u) annotation(
          Line(points = {{-98, 0}, {-86, 0}}));
        annotation(
          Icon(graphics = {Bitmap(origin = {-3, -9}, extent = {{89, -89}, {-89, 89}}, imageSource = "")}));
      end Motor;
      ...
      equation
        u = der(flange.phi);
        annotation(
          Icon(graphics = {Line(points = {{0, -32}, {0, -100}}), Line(points = {{-30, -32}, {30, -32}}), Line(points = {{-30, -100}, {30, -100}}), Text(textColor = {0, 0, 255}, extent = {{-150, 60}, {150, 100}}, textString = "%name"), Line(points = {{-29, 32}, {30, 32}}), Line(points = {{-10, -120}, {10, -100}}), Line(points = {{-50, -120}, {-30, -100}}), Line(points = {{0, 52}, {0, 32}}), Rectangle(lineColor = {64, 64, 64}, fillColor = {192, 192, 192}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, -20}, {100, 20}}), Line(points = {{-30, -120}, {-10, -100}}), Line(points = {{10, -120}, {30, -100}})}));
      end SpeedSource;
    end PROBLEMA_10;
    ...
    package PROBLEMA_11
      model OneWayValve
        extends DSFLib.Hydraulics.Interfaces.TwoPort;
        parameter Real Roff = 1e12, Ron = 1e-6;
      equation
        p = if q > 0 then q*Ron else q*Roff;
        annotation(
          Icon(graphics = {Polygon(origin = {-4, 0}, lineColor = {0, 128, 255}, fillColor = {0, 128, 255}, fillPattern = FillPattern.Solid, points = {{20, -70}, {60, -85}, {20, -100}, {20, -70}}), Line(points = {{55, -85}, {-60, -85}}, color = {0, 128, 255}), Polygon(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-100, 50}, {100, -50}, {100, 50}, {0, 0}, {-100, -50}, {-100, 50}}), Text(origin = {0, 14}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Polygon(origin = {-4, 0}, lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{20, -75}, {50, -85}, {20, -95}, {20, -75}})}));
      end OneWayValve;

      model Bomba
        DSFLib.Mechanical.Translational.Components.Fixed fixed annotation(
          Placement(visible = true, transformation(origin = {26, -22}, extent = {{-8, -8}, {8, 8}}, rotation = 90)));
        MultiDomain.HydroMechanical.Components.PistonCylinder pistonCylinder(A = 0.01) annotation(
        ...
        DSFLib.Hydraulics.Components.Tank tank annotation(
          Placement(visible = true, transformation(origin = {7.10543e-15, 80}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_11.OneWayValve oneWayValve_up annotation(
          Placement(visible = true, transformation(origin = {0, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
        DSFLib.PROBLEMAS.PROBLEMA_11.OneWayValve oneWayValve_down annotation(
        ...
        DSFLib.PROBLEMAS.PROBLEMA_11.ModulatedPosition position annotation(
          Placement(visible = true, transformation(origin = {-36, -22}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_11.sin sin annotation(
          Placement(visible = true, transformation(origin = {-70, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(tank.fluidPort, column.fluidPort_a) annotation(
          Line(points = {{7.0699e-15, 64}, {7.0699e-15, 50}}));
        connect(pistonCylinder.flange_a, fixed.flange) annotation(
          Line(points = {{6, -22}, {26, -22}}));
        connect(oneWayValve_up.fluidPort_a, column.fluidPort_a) annotation(
          Line(points = {{0, 20}, {0, 30}}));
        connect(pistonCylinder.fluidPort, oneWayValve_down.fluidPort_a) annotation(
          Line(points = {{0, -30}, {0, -46}}));
        connect(valve.fluidPort_b, tank.fluidPort) annotation(
          Line(points = {{30, 56}, {0, 56}, {0, 64}}));
        connect(oneWayValve_up.fluidPort_b, pistonCylinder.fluidPort) annotation(
          Line(points = {{0, 0}, {0, -6}, {16, -6}, {16, -36}, {0, -36}, {0, -30}}));
        connect(constPress.fluidPort, valve.fluidPort_a) annotation(
          Line(points = {{66, 56}, {50, 56}}));
        connect(constPress1.fluidPort, oneWayValve_down.fluidPort_b) annotation(
          Line(points = {{0, -78}, {0, -66}}));
        connect(position.flange, pistonCylinder.flange_b) annotation(
          Line(points = {{-24, -22}, {-14, -22}}));
        connect(sin.y, position.u) annotation(
          Line(points = {{-58, -22}, {-49.4, -22}}));
      end Bomba;
      ...
      block sin
        DSFLib.ControlSystems.Blocks.Interfaces.RealOutput y annotation(
          Placement(visible = true, transformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {116, -8.88178e-16}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
        parameter Real Amplitude = 1, Freq(unit = "Hz") = 1, Offset = 0.0, Phase(unit = "°(degrees)") = 0.0;
      equation
        y = Amplitude*Modelica.Math.sin(2*Modelica.Constants.pi*Freq*time + 2*Modelica.Constants.pi*Phase/360) + Offset;
        annotation(
          Icon(graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, -100}, {100, 100}}), Line(points = {{-90, 0}, {68, 0}}, color = {95, 95, 95}), Polygon(lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid, points = {{-80, 90}, {-88, 68}, {-72, 68}, {-80, 90}}), Line(points = {{-80, -86}, {-80, 68}}, color = {95, 95, 95}), Polygon(lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid, points = {{90, 0}, {68, 8}, {68, -8}, {90, 0}}), Text(textColor = {192, 192, 192}, extent = {{12, 84}, {84, 36}}, textString = "sin"), Text(textColor = {0, 0, 255}, extent = {{-150, 150}, {150, 110}}, textString = "%name"), Line(points = {{-80, 0}, {-68.7, 34.2}, {-61.5, 53.1}, {-55.1, 66.4}, {-49.4, 74.6}, {-43.8, 79.1}, {-38.2, 79.8}, {-32.6, 76.6}, {-26.9, 69.7}, {-21.3, 59.4}, {-14.9, 44.1}, {-6.83, 21.2}, {10.1, -30.8}, {17.3, -50.2}, {23.7, -64.2}, {29.3, -73.1}, {35, -78.4}, {40.6, -80}, {46.2, -77.6}, {51.9, -71.5}, {57.5, -61.9}, {63.9, -47.2}, {72, -24.8}, {72, -24}}, thickness = 0.5, smooth = Smooth.Bezier)}));
      end sin;
    end PROBLEMA_11;
    ...
    package PROBLEMA_14
      block PWMSignal
        extends DSFLib.ControlSystems.Blocks.Interfaces.SISO;
        parameter Real T(unit = "s") = 1 "Period";
        discrete Real yd;
        discrete Real dc;
        discrete Real tlast;
      equation
      ...
      algorithm
        when sample(0, T) then
          yd := 1;
          dc := min(max(u, 1e-5), 0.99999);
          tlast := time;
        end when;
        when time > tlast + dc*T then
          yd := 0;
        end when;
        annotation(
          Icon(graphics = {Line(origin = {56.406, -17}, points = {{-12, -63}, {-12, 63}, {12, 63}, {12, 63}}, thickness = 0.5), Line(origin = {0, -10}, points = {{-90, -70}, {82, -70}}, color = {95, 95, 95}), Polygon(lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid, points = {{-80, 90}, {-86, 68}, {-74, 68}, {-80, 90}}), Polygon(origin = {0, -10}, lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid, points = {{90, -70}, {68, -64}, {68, -76}, {90, -70}}), Line(origin = {0, -10}, points = {{-80, 80}, {-80, -80}}, color = {95, 95, 95}), Text(textColor = {0, 0, 255}, extent = {{-150, 150}, {150, 110}}, textString = "%name"), Text(extent = {{-147, -152}, {153, -112}}, textString = "T=%T"), Line(origin = {0.811, -9.62207}, points = {{-80, 56}, {-36, 56}, {-36, -70}, {-18, -70}, {-18, 56}, {24, 56}, {24, -70}, {43, -70}}, thickness = 0.5)}));
      end PWMSignal;

      model ControlBuck
        DSFLib.ControlSystems.Sensors.Circuits.VoltageSensor voltageSensor annotation(
        ...
        DSFLib.ControlSystems.Blocks.Components.StepSource u_ref(Ti = 0, U = 6) annotation(
        ...
        DSFLib.ControlSystems.Blocks.Components.Add add1(k1 = 0.2, k2 = 100) annotation(
          Placement(visible = true, transformation(origin = {-22, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Circuits.Components.Diode D annotation(
          Placement(visible = true, transformation(origin = {6, -26}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
        DSFLib.Circuits.Components.Ground ground annotation(
        ...
        DSFLib.Circuits.Components.Resistor RL(R = 10) annotation(
          Placement(visible = true, transformation(origin = {80, -26}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.PROBLEMAS.PROBLEMA_1.CommandedSwitch Sw annotation(
          Placement(visible = true, transformation(origin = {-14, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Circuits.Components.ConstVolt Vin(V = 12) annotation(
          Placement(visible = true, transformation(origin = {-34, -26}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.Circuits.Components.Capacitor C(C = 1e-4) annotation(
          Placement(visible = true, transformation(origin = {52, -26}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.PROBLEMAS.PROBLEMA_14.PWMSignal pWMSignal(T = 1e-4) annotation(
      ...
      equation
        connect(integrator.y, add1.u2) annotation(
          Line(points = {{-44.2, 30}, {-34.6, 30}}));
        connect(add1.u1, add.y) annotation(
          Line(points = {{-33.7, 41.9}, {-76.55, 41.9}, {-76.55, 29.9}, {-81.7, 29.9}}));
        connect(integrator.u, add.y) annotation(
          Line(points = {{-67.7, 30.1}, {-81.7, 30.1}}));
        connect(u_ref.y, add.u1) annotation(
          Line(points = {{-120.4, 36}, {-106.4, 36}}));
        connect(add.u2, voltageSensor.y) annotation(
          Line(points = {{-106, 24}, {-113.6, 24}, {-113.6, -68}, {102.4, -68}, {102.4, -14}}));
        connect(Sw.n, D.n) annotation(
          Line(points = {{-4, -2}, {6, -2}, {6, -16}}));
        connect(L.p, Sw.n) annotation(
          Line(points = {{18, -2}, {-4, -2}}));
        connect(C.n, ground.p) annotation(
          Line(points = {{52, -36}, {52, -48}, {28, -48}}));
        connect(RL.n, ground.p) annotation(
          Line(points = {{80, -36}, {80, -48}, {28, -48}}));
        connect(Sw.p, Vin.p) annotation(
          Line(points = {{-24, -2}, {-34, -2}, {-34, -16}}));
        connect(L.n, RL.p) annotation(
          Line(points = {{38, -2}, {80, -2}, {80, -16}}));
        connect(Vin.n, ground.p) annotation(
          Line(points = {{-34, -36}, {-34, -48}, {28, -48}}));
        connect(D.p, ground.p) annotation(
          Line(points = {{6, -36}, {6, -48}, {28, -48}}));
        connect(L.n, C.p) annotation(
          Line(points = {{38, -2}, {52, -2}, {52, -16}}));
        connect(add1.y, pWMSignal.u) annotation(
          Line(points = {{-10, 35.8}, {-3, 35.8}, {-3, 36}, {-2, 36}}));
        connect(pWMSignal.y, Sw.u) annotation(
          Line(points = {{22, 36}, {33.8, 36}, {33.8, 16}, {-14.2, 16}, {-14.2, 4}}));
        connect(voltageSensor.p, L.n) annotation(
          Line(points = {{92, -2}, {38, -2}}));
        connect(voltageSensor.n, ground1.p) annotation(
          Line(points = {{112, -2}, {126, -2}, {126, -10}}));
      end ControlBuck;
    end PROBLEMA_14;
    ...
    package PROBLEMA_15
      model TankHeight
        DSFLib.Hydraulics.Interfaces.FluidPort fluidPort annotation(
          Placement(visible = true, transformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-2.22045e-16, -100}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Interfaces.RealOutput h annotation(
        ...
        DSFLib.Hydraulics.Interfaces.FluidPort fluidPort_up annotation(
          Placement(visible = true, transformation(origin = {-100, 78}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 100}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
        parameter Real A(unit = "m^2") = 1 "Tank area";
        parameter Real g(unit = "m/s^2") = 9.8;
        parameter Real rho(unit = "Kg/m^3") = 1000 "Fluid density";
        Real v(unit = "m^3");
      ...
      equation
        ...
        fluidPort.p = p + dp;
        annotation(
          Icon(graphics = {Polygon(origin = {-72, 65}, fillColor = {0, 170, 255}, fillPattern = FillPattern.Solid, points = {{0, -7}, {6, 7}, {-6, 7}, {0, -7}, {0, -7}}), Polygon(origin = {-92, 87}, fillColor = {0, 170, 255}, fillPattern = FillPattern.Solid, points = {{-16, 15}, {22, 15}, {22, -15}, {18, -15}, {18, 11}, {-22, 11}, {-16, 15}, {-16, 15}}), Line(points = {{-100, 100}, {-100, -100}, {100, -100}, {100, 100}}), Text(extent = {{-95, -24}, {95, -44}}, textString = "%level_start"), Text(origin = {29, 70}, extent = {{-103, 10}, {49, -10}}, textString = "A=%A"), Rectangle(fillColor = {85, 170, 255}, fillPattern = FillPattern.VerticalCylinder, extent = {{-100, -100}, {100, 10}}), Text(textColor = {0, 0, 255}, extent = {{-150, 110}, {150, 150}}, textString = "%name")}));
      end TankHeight;

      model ModulatedValve
        extends DSFLib.Hydraulics.Interfaces.TwoPort;
        DSFLib.ControlSystems.Blocks.Interfaces.RealInput u annotation(
          Placement(visible = true, transformation(origin = {0, 96}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 70}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        parameter Real G = 1e-5;
      equation
        q = min(max(u, 0), 1)*G*sqrt(abs(p))*sign(p);
        annotation(
          Icon(graphics = {Line(visible = false, points = {{-20, 25}, {-20, 63}, {0, 41}, {20, 63}, {20, 25}}, thickness = 0.5), Polygon(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-100, 50}, {100, -50}, {100, 50}, {0, 0}, {-100, -50}, {-100, 50}}), Ellipse(visible = false, lineColor = {0, 0, 127}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-40, 94}, {40, 14}}), Polygon(points = {{-100, 50}, {100, -50}, {100, 50}, {0, 0}, {-100, -50}, {-100, 50}}), Line(points = {{0, 52}, {0, 0}}), Polygon(lineColor = {255, 255, 255}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, points = {{-100, 0}, {100, 0}, {100, 0}, {0, 0}, {-100, 0}, {-100, 0}}), Rectangle(fillPattern = FillPattern.Solid, extent = {{-20, 60}, {20, 52}}), Text(origin = {0, -146}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Text(origin = {0, -64}, extent = {{-150, -40}, {150, -80}}, textString = "G=%G")}));
      end ModulatedValve;

      model ControlTanue
        DSFLib.ControlSystems.Blocks.Components.Add add(k1 = 10, k2 = -10) annotation(
        ...
        DSFLib.ControlSystems.Blocks.Components.StepSource stepSource1(Tstep = 500) annotation(
          Placement(visible = true, transformation(origin = {36, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_15.TankHeight tank annotation(
          Placement(visible = true, transformation(origin = {1.77636e-15, -14}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_15.ModulatedValve modulatedValve annotation(
          Placement(visible = true, transformation(origin = {-42, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_15.ModulatedValve modulatedValve1 annotation(
      ...
      equation
        connect(stepSource.y, add.u1) annotation(
          Line(points = {{34, 40}, {12, 40}}));
        connect(tank.fluidPort, modulatedValve1.fluidPort_b) annotation(
          Line(points = {{0, -30}, {0, -60}, {50, -60}}));
        connect(modulatedValve.fluidPort_a, tank.fluidPort_up) annotation(
          Line(points = {{-32, 2}, {-16, 2}}));
        connect(constPress.fluidPort, modulatedValve.fluidPort_b) annotation(
          Line(points = {{-64, 2}, {-52, 2}}));
        connect(stepSource1.y, modulatedValve1.u) annotation(
          Line(points = {{48, -40}, {60, -40}, {60, -52}}));
        connect(constPress1.fluidPort, modulatedValve1.fluidPort_a) annotation(
          Line(points = {{86, -60}, {70, -60}}));
        connect(tank.h, add.u2) annotation(
          Line(points = {{18, -8}, {28, -8}, {28, 28}, {12, 28}}));
        connect(add.y, modulatedValve.u) annotation(
          Line(points = {{-12, 34}, {-42, 34}, {-42, 10}}));
      end ControlTanue;
    end PROBLEMA_15;

    package PROBLEMA_16
      model RefrigeracionMotor
        DSFLib.Thermal.Components.ConstTemp constTemp annotation(
          Placement(visible = true, transformation(origin = {8, -46}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
        DSFLib.Thermal.Components.ThermalResistor Rra(R = 0.004) annotation(
        ...
        DSFLib.Thermal.Components.HeatFlowSource qm_in(Q = 10e4) annotation(
          Placement(visible = true, transformation(origin = {-132, 58}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Thermal.Components.HeatCapacitor Motor(C = 5e4) annotation(
          Placement(visible = true, transformation(origin = {-104, 74}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
        DSFLib.Thermal.Components.ConstTemp Tamb annotation(
          Placement(visible = true, transformation(origin = {124, 58}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
        DSFLib.ControlSystems.Blocks.Components.Gain gain(K = 1/100) annotation(
          Placement(visible = true, transformation(origin = {22, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.Thermal.Components.ThermalResistor Rwm(R = 0.001) annotation(
          Placement(visible = true, transformation(origin = {-80, 58}, extent = {{10, -10}, {-10, 10}}, rotation = -180)));
        DSFLib.Thermal.Components.HeatCapacitor AguaRadiador(C = 1e4) annotation(
          Placement(visible = true, transformation(origin = {68, 74}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
        DSFLib.Thermal.Components.HeatCapacitor AguaMotor(C = 1e4) annotation(
          Placement(visible = true, transformation(origin = {-58, 74}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
        DSFLib.MultiDomain.HydroThermal.Components.Convection convection annotation(
          Placement(visible = true, transformation(origin = {6, 64}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        DSFLib.PROBLEMAS.PROBLEMA_16.ModulatedValve modulatedValve annotation(
        ...
        DSFLib.PROBLEMAS.PROBLEMA_16.DiferencePressure deltaPress(P = 1000) annotation(
          Placement(visible = true, transformation(origin = {-32, 34}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        DSFLib.ControlSystems.Sensors.Thermal.TemperatureSensor temperatureSensor annotation(
          Placement(visible = true, transformation(origin = {-26, -46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(Rwm.heatPort_b, Motor.heatPort) annotation(
          Line(points = {{-90, 58}, {-104, 58}, {-104, 64}}));
        connect(Rwm.heatPort_a, AguaMotor.heatPort) annotation(
          Line(points = {{-70, 58}, {-58, 58}, {-58, 64}}));
        connect(AguaRadiador.heatPort, Rra.heatPort_b) annotation(
          Line(points = {{68, 64.4}, {68, 58}, {82, 58}}));
        connect(qm_in.heatPort, Motor.heatPort) annotation(
          Line(points = {{-122, 58}, {-104, 58}, {-104, 64}}));
        connect(Tamb.heatPort, Rra.heatPort_a) annotation(
          Line(points = {{114.3, 57.9}, {102.3, 57.9}}));
        connect(modulatedValve.fluidPort_a, convection1.fluidPort_b) annotation(
          Line(points = {{42, 18}, {42, -12}, {16, -12}}));
        connect(deltaPress.fluidPort_b, convection.fluidPort_b) annotation(
          Line(points = {{-32, 44}, {-32, 64}, {-4, 64}}));
        connect(convection.fluidPort_a, modulatedValve.fluidPort_b) annotation(
          Line(points = {{16, 64}, {42, 64}, {42, 38}}));
        connect(convection.heatPort_b, AguaMotor.heatPort) annotation(
          Line(points = {{-4, 58}, {-58, 58}, {-58, 64}}));
        connect(convection.heatPort_a, AguaRadiador.heatPort) annotation(
          Line(points = {{16, 58}, {68, 58}, {68, 64}}));
        connect(AguaRadiador.heatPort, convection1.heatPort_b) annotation(
          Line(points = {{68, 64.4}, {68, -17.6}, {16, -17.6}}));
        connect(convection1.heatPort_a, AguaMotor.heatPort) annotation(
          Line(points = {{-4, -18}, {-58, -18}, {-58, 64}}));
        connect(constPress.fluidPort, deltaPress.fluidPort_a) annotation(
          Line(points = {{-6, 16}, {-32, 16}, {-32, 24}}));
        connect(convection1.fluidPort_a, constPress.fluidPort) annotation(
          Line(points = {{-4, -12}, {-32, -12}, {-32, 16}, {-6, 16}}));
        connect(gain.y, modulatedValve.u) annotation(
          Line(points = {{33.8, -72}, {57.1, -72}, {57.1, 28}, {48.6, 28}}));
        connect(temperatureSensor.heatPort_a, constTemp.heatPort) annotation(
          Line(points = {{-16, -46}, {-2, -46}}));
        connect(temperatureSensor.heatPort_b, AguaMotor.heatPort) annotation(
          Line(points = {{-36, -46}, {-58, -46}, {-58, 64}}));
      end RefrigeracionMotor;
      ...
      model DiferencePressure
        extends DSFLib.Hydraulics.Interfaces.TwoPort;
        parameter Real P(unit = "Pa") = 0;
      equation
        p = P;
        annotation(
          Icon(graphics = {Text(origin = {-26, 107}, rotation = 180, extent = {{-210, 7}, {152, -9}}, textString = "ΔP=%P"), Text(origin = {0, -200}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Rectangle(origin = {71, 0}, fillColor = {0, 127, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-29, 32}, {29, -32}}), Rectangle(origin = {-71, 0}, fillColor = {0, 127, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-29, 32}, {29, -32}}), Ellipse(fillColor = {0, 170, 255}, fillPattern = FillPattern.Sphere, extent = {{-80, 80}, {80, -80}}), Line(origin = {-10.1664, 40.0303}, points = {{-70, 30}, {-70, 10}}, color = {0, 0, 255}), Line(origin = {-10.1664, 40.0303}, points = {{-80, 20}, {-60, 20}}, color = {0, 0, 255})}));
      end DiferencePressure;
    end PROBLEMA_16;
  end PROBLEMAS;
  annotation(
    uses(Modelica(version = "3.2.3")));
